...
describe 'tcpwrappers' do
  ...
  describe 'Test customizations - custom class' do
    ...
    it { is_expected.to contain_file('allow.file').with_content(%r{rspec.example42.com}) }
  end
end
